...
class OrderServiceTest {
    ...
    void sagaEventsUpdateOrderReadModel() {
        ...
        orderService.markInventoryFailed(event("inventory-failed-0-2", "InventoryFailedEvent"), "OUT_OF_STOCK");
        ...
        orderService.markRefunded(event("payment-refunded-0-3", "PaymentRefundedEvent"), "Inventory unavailable");
