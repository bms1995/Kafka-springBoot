...
public class InventoryUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 597042208874937546L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"InventoryUpdatedEvent\",\"namespace\":\"com.example.events\",\"fields\":[{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public InventoryUpdatedEvent(java.lang.String orderId, java.lang.String status) {
   ...
   */
  public static com.example.events.InventoryUpdatedEvent.Builder newBuilder() {
    return new com.example.events.InventoryUpdatedEvent.Builder();
  }
   ...
   * @return A new InventoryUpdatedEvent RecordBuilder
   */
  public static com.example.events.InventoryUpdatedEvent.Builder newBuilder(com.example.events.InventoryUpdatedEvent.Builder other) {
    if (other == null) {
      return new com.example.events.InventoryUpdatedEvent.Builder();
    } else {
      return new com.example.events.InventoryUpdatedEvent.Builder(other);
    }
  }
   ...
   * @return A new InventoryUpdatedEvent RecordBuilder
   */
  public static com.example.events.InventoryUpdatedEvent.Builder newBuilder(com.example.events.InventoryUpdatedEvent other) {
    if (other == null) {
      return new com.example.events.InventoryUpdatedEvent.Builder();
    } else {
      return new com.example.events.InventoryUpdatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InventoryUpdatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.events.InventoryUpdatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.events.InventoryUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.events.InventoryUpdatedEvent.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.events.InventoryUpdatedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.events.InventoryUpdatedEvent.Builder setStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.events.InventoryUpdatedEvent.Builder clearStatus() {
      status = null;
